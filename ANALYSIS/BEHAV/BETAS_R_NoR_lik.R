...
figure1 <- ggarrange(A1,B1,C1,D1,A2,B2,C2,D2,A3,B3,C3,D3,A4,B4,C4,
                     labels = c("CAUD_LEFT_betas" ,    "Caud_Left_Clu_betas", "Oper_Left_clu_betas" ,"IFG_LEFT_betas"    ,  "IFG_RIGHT_betas",
 "OFC_RIGHT_betas" ,    "OPER_LEFT_betas"   ,  "PUT_LEFT_betas"    ,  "Put_Left_clu_betas" , "SUBCAL_RIGHT_betas" , "Snr_betas" ,         
"midbrain_betas",      "vlPFC_RIGHT_betas" ,  "vmPFC_LEFT_betas",    "vmPFC_RIGHT_betas"),
                     ncol = 2, nrow = 8,
                     vjust=3, hjust=0) 

figure1 <- annotate_figure(figure1,
                           top = text_grob("Coeficient of determination: REWARD - NO REWARD via R_NoRoR for LIKING", color = "black", face = "bold", size = 14),
                           bottom = "Figure 1", fig.lab.face = "bold")

pdf('~/REWOD/DERIVATIVES/BEHAV/HED/R_NoR_viaR_NoRoR_lik_coeff.pdf')
plot(figure1)
dev.off()
...
# A4 <- ggplotRegression(lm(R_NoR_df[[14]]~int)) + rremove("x.title")
# B4 <- ggplotRegression(lm(R_NoR_df[[15]]~int)) + rremove("x.title")
# C4 <- ggplotRegression(lm(R_NoR_df[[16]]~int)) + rremove("x.title")
# 
# 
# figure2 <- ggarrange(A1,B1,C1,D1,A2,B2,C2,D2,A3,B3,C3,D3,A4,B4,C4,
#                      labels = c("CAUD_LEFT_betas" ,    "Caud_Left_Clu_betas", "Oper_Left_clu_betas" ,"IFG_LEFT_betas"    ,  "IFG_RIGHT_betas",
#                                 "OFC_RIGHT_betas" ,    "OPER_LEFT_betas"   ,  "PUT_LEFT_betas"    ,  "Put_Left_clu_betas" , "SUBCAL_RIGHT_betas" , "Snr_betas" ,         
#                                 "midbrain_betas",      "vlPFC_RIGHT_betas" ,  "vmPFC_LEFT_betas",    "vmPFC_RIGHT_betas"),
#                      ncol = 2, nrow = 8,
...
#                            top = text_grob("Coeficient of determination: REWARD - NO REWARD via R_NoR  for INTENSITY", color = "black", face = "bold", size = 14),
#                            bottom = "Figure 2", fig.lab.face = "bold")
# 
# 
# pdf('~/REWOD/DERIVATIVES/BEHAV/HED/R_NoR_viaR_NoR_int_coeff.pdf')
# plot(figure2)
# dev.off()
# 
# 
