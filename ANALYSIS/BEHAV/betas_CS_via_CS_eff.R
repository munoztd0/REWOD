...
figure1 <- ggarrange(A1,B1,C1,D1,A2,B2,C2,D2,A3,B3,C3,
                     labels = c( "AMY_LEFT_betas" ,        "AMY_RIGHT_betas" ,       "AMY_post_RIGHT_betas",   "BNST_LEFT_betas",        "BNST_RIGHT_betas" ,     
 "CAUD_VENTR_LEFT_betas" , "CAUD_VENTR_RIGHT_betas", "PUT_LEFT_betas"   ,      "pINS_RIGHT_betas" ,      "vlPFC_LEFT_betas"  ,     "vlPFC_RIGHT_betas" ),
                     ncol = 2, nrow = 6,
                     vjust=3, hjust=0) 


figure1 <- annotate_figure(figure1,
                           top = text_grob("Coeficient of determination: CSp-CSm via CSp-CSm_eff for Effort", color = "black", face = "bold", size = 14),
