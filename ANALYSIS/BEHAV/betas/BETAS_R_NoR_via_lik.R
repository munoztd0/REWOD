...
figure1 <- ggarrange(A1,B1,C1,D1,A2,B2,C2,D2,A3,B3,C3,D3,
                     labels = c( "CAUD_VENTR_LEFT_betas" , "CAUD_VENTR_RIGHT_betas", "NACC_RIGHT_betas"   ,    "NAcc_Left_Clu_betas",    "OFC_LEFT_betas",        
                                 "OFC_RIGHT_betas"  ,      "PUT_POST_RIGHT_betas"  , "Put_ant_LEFT_betas"  ,   "SUBCAL_LEFT_betas"  ,    "SUBCAL_RIGHT_betas",
                                 "aINS_LEFT_betas",  "aINS_RIGHT_betas" ),
                     ncol = 2, nrow = 6,
                     vjust=3, hjust=0) 


figure1 <- annotate_figure(figure1,
                           top = text_grob("Coeficient of determination: REWARD - NO REWARD via lik for LIKING", color = "black", face = "bold", size = 14),
                           bottom = "Figure 1", fig.lab.face = "bold")

pdf('~/REWOD/DERIVATIVES/BEHAV/HED/R_NoR_via_lik_lik_coeff.pdf')
plot(figure1)
dev.off()
