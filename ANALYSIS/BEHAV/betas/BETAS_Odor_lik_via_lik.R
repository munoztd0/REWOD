...
#extracted_betas_odor_lik_via_lik.txt
...
LIK_R_NoR <- read.delim(file.path(analysis_path, 'GLM-04', 'group_covariates', paste(con3,'_', mod1, '_meancent.txt',sep="")), header = T, sep ='\t') # read in dataset
#LIK_R_N <- read.delim(file.path(analysis_path, 'GLM-04', 'group_covariates', paste(con3,'_', mod1, '_meancent.txt',sep="")), header = T, sep ='\t') # read in dataset
...
figure1 <- ggarrange(A1,B1,C1,D1,A2,B2,C2,D2,A3,B3,C3,
                     labels = c( "CAUD_VENTR_LEFT_betas",  "CAUD_VENTR_RIGHT_betas" ,"NACC_RIGHT_betas"  ,  
...
figure2 <- ggarrange(A1,B1,C1,D1,A2,B2,C2,D2,A3,B3,C3,
                     labels = c( "CAUD_VENTR_LEFT_betas",  "CAUD_VENTR_RIGHT_betas" ,"NACC_RIGHT_betas"  ,    
                                 "OFC_LEFT_betas"     ,    "OFC_RIGHT_betas"   ,     "PUT_POST_RIGHT_betas"  , "Put_ant_LEFT_betas" ,    "SUBCAL_LEFT_betas"   ,  
                                 "SUBCAL_RIGHT_betas"   ,  "aINS_LEFT_betas" ,       "aINS_RIGHT_betas"),
                     ncol = 2, nrow = 6,
