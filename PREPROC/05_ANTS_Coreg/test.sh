...
# Define subject images (moving) T1/SBref & masks file names  ## was T1w before
moving_T1=${subAnatDir}sub-${subjID}_ses-second_run-01_sbref_reoriented_brain_restore_unwarped
moving_mask=${subAnatDir}sub-${subjID}_ses-second_run-01_sbref_reoriented_brain_restore_unwarped_mask
pref=${subAnatDir}sub-${subjID}_ses-second_run-01_T1w_reoriented_brain
